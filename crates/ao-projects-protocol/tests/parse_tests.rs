...
fn parse_requirement_status() {
    assert_eq!(
        "draft".parse::<RequirementStatus>().unwrap(),
        RequirementStatus::Draft
    );
    assert_eq!(
        "refined".parse::<RequirementStatus>().unwrap(),
        RequirementStatus::Refined
    );
    assert_eq!(
        "planned".parse::<RequirementStatus>().unwrap(),
        RequirementStatus::Planned
    );
    assert_eq!(
        "po-review".parse::<RequirementStatus>().unwrap(),
        RequirementStatus::PoReview
    );
    assert_eq!(
        "em-review".parse::<RequirementStatus>().unwrap(),
        RequirementStatus::EmReview
    );
    assert_eq!(
        "needs-rework".parse::<RequirementStatus>().unwrap(),
        RequirementStatus::NeedsRework
    );
    assert_eq!(
        "approved".parse::<RequirementStatus>().unwrap(),
        RequirementStatus::Approved
    );
    assert_eq!(
        "implemented".parse::<RequirementStatus>().unwrap(),
...
fn parse_requirement_priority() {
    assert_eq!(
        "must".parse::<RequirementPriority>().unwrap(),
        RequirementPriority::Must
    );
    assert_eq!(
        "should".parse::<RequirementPriority>().unwrap(),
        RequirementPriority::Should
    );
    assert_eq!(
        "could".parse::<RequirementPriority>().unwrap(),
        RequirementPriority::Could
    );
    assert_eq!(
        "wont".parse::<RequirementPriority>().unwrap(),
